...
class MaoYan():
    def __init__(self):
        ...
        self.font = TTFont('files/fonts/base_font.woff')
        self.web_font = ''
        self.web_html = ''
        self.web_html_text = ''
    ...
    def get_city_id(self, city):
        ...
        city_id = -1
        with open('files/city.json', 'r') as r:
            id = r.read()
    ...
    def get_timetable_from_maoyan(self, date_mark='1', cinema_url='https://maoyan.com/cinema/17000?poi=150594634',
                                  movie_name='爱宠'):
        try:
        ...
        try:
            ...
            one_result = etree.HTML(result_tbody[date_mark])
        except:
            print('电影信息获取错误')
            return []
        ...
        prices = re.findall('<span class="stonefont">(.*?)</span>', result_tbody[date_mark])
...
if __name__ == '__main__':
    m = MaoYan()
    print(m.get_timetable_from_maoyan(date_mark='1', cinema_url='https://maoyan.com/cinema/17000?poi=150594634',
                                  movie_name='蜘蛛侠'))
